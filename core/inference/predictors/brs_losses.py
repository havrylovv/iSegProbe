"""Loss functions that are used with BRS (Backpropagation Refinement Scheme) predictors."""

from typing import Tuple

import torch

from core.training.losses import SigmoidBinaryCrossEntropyLoss
...
class BRSMaskLoss(torch.nn.Module):
    ...
    def forward(
        self, result: torch.Tensor, pos_mask: torch.Tensor, neg_mask: torch.Tensor
...
class OracleMaskLoss(torch.nn.Module):
    ...
    def set_gt_mask(self, gt_mask: torch.Tensor) -> None:
