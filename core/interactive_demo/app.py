...
class InteractiveDemoApp(ttk.Frame):
        ...
        self.state = {
            "zoomin_params": {
                ...
                "target_size": tk.IntVar(
                    value=448
                ),  # tk.IntVar(value=min(400, self.limit_longest_size)),
    ...
    def _add_menu(self):
        ...
        button = FocusButton(
            self.menubar, text="Load image", command=self._load_image_callback
        )
        button.pack(side=tk.LEFT)
        self.save_mask_btn = FocusButton(
            self.menubar, text="Save mask", command=self._save_mask_callback
        )
    ...
    def _about_callback(self):
        ...
        text = ["Developed by:", "K.Sofiiuk and I. Petrov", "The MIT License, 2021"]
