...
from core.inference import clicker
from core.inference.predictors import get_predictor
from core.utils.viz import draw_with_blend_and_clicks


class InteractiveController:
    def __init__(
        self, net, device, predictor_params, update_image_callback, prob_thresh=0.5
    ):
        self.net = net
    ...
    def reset_predictor(self, predictor_params=None):
        ...
        self.predictor = get_predictor(
            self.net, device=self.device, **self.predictor_params
        )
