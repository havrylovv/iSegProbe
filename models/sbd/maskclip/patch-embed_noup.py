...
def define_modules_cfg(cfg: DictConfig) -> edict:
    ...
    """
    # unique model name
    MODEL_NAME = "sbd_maskclip_noup_convhead_patchembed_earlyinject_224"
    ...
    embed_coords_cfg = dict(
        type="patchEmbed",
        params=dict(
            img_size=cfg.training_params.crop_size,
            patch_size=(16, 16),
            embed_dim=768,  # for late injection set embed_dim=512
        ),
    )
